...
To reference pages on your introduction page, you will create a bae of code that says - [Page 1: Page 1 for project(name)](Page1.(projectname)- meaning to call that project so that code is linked to the page. This amkes for easy accsess for users acsessing your page. 
After you have created the amount of pages you want and you are ready to share your work, go back to the main page of your project. Here you will find a GREEN button that says 'Code'. This is where you will find you URL link and you can copy it to your computer. 
And that how you share it!
Other than creating repsorities, You can create Codespaces and input repsorites as well on Github. 
Now you are a Github reportory expert! 
